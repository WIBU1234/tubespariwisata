...
class _ReviewDestinasiWisataState extends State<ReviewDestinasiWisata> {
  ...
  void setForce() {
    ApiReviewHelper.getReview().listen((reviews) {
      setState(() {
        reviewList = reviews;
      });
    }, onError: (error) {
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text(
                                  findUser(reviews.idUser) as String,
                                  style: const TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.black,
  ...
  Future<String> findUser(int? idUser) async {
    User userTemp = await loginRegisHelper.loginById(id: idUser!);
